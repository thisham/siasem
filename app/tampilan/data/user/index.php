<div class="container">
    <div class="card">
        ...
        <div class="card-content">
            <ul class="collection">
                <a class="collection-item indigo-text" href="<?= basis_url('data/user/kepala-sekolah'); ?>">Kepala Sekolah <i class="material-icons right">chevron_right</i></a>
                <a class="collection-item indigo-text" href="<?= basis_url('data/user/guru'); ?>">Guru <i class="material-icons right">chevron_right</i></a>
